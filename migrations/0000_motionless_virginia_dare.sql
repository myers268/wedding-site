...
CREATE UNIQUE INDEX `idx_guest_event_attendance` ON `event_attendance` (`guest_id`,`event_id`);--> statement-breakpoint
CREATE TABLE `guest` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `idx_guest_primary` ON `guest` (`primary_guest_id`);